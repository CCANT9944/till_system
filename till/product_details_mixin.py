...
class ProductDetailsMixin:
    ...
    def build_product_details_tab(self) -> None:
        ...
        self.product_details_search.setMinimumHeight(40)
        ...
        self.product_details_edit_button.setMinimumHeight(40)
        ...
        self.product_details_delete_button.setMinimumHeight(40)
